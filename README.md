...
- Find by Conditions: Combination of Buyer, Seller, Currency & Amount (EQUALS, GREATER_THAN, LESS_THAN). More than one condition can be used to search. Consider following condition to search
    ```
    {
        "conditions": [
            {
